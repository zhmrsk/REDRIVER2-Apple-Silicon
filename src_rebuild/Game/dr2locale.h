...
enum GameStrId
{
	...
	GTXT_SurveillanceTipOff,
	GTXT_AutoTesting,
	GTXT_LennyGetsCaught,

	GTXT_DirectorsCut,
	GTXT_ChooseACutscene,

	GTXT_Sfx,
	GTXT_Music,
	GTXT_SetVolumeLevels,
...
// fancy logic
#define GET_GAME_TXT(st)		(((u_intptr)st < MAX_LANGUAGE_TEXT && st) ? gGameLangTable[(intptr_t)st] : st)
#define GET_MISSION_TXT(st)		(((u_intptr)st < MAX_LANGUAGE_TEXT && st) ? gMissionLangTable[(intptr_t)st] : st)
...
#define G_LTXT_ID(id)			#id //G_LTXT(id)
#define M_LTXT_ID(id)			#id //M_LTXT(id)
