...
-- settings in a particular project filter.
--
-- @param cfg
--    The project filter.
-- @return
...
-- a particular project filter. These flags are exclusive
...
-- in a particular project filter. These flags are exclusive
-- of the C compiler flags, there is no overlap.
--
-- @param cfg
--    The project filter.
...
-- project filter, decorated for the tool command line.
--
-- @param cfg
--    The project filter.
-- @return
...
-- filter, decorated for the linker command line.
--
-- @param cfg
--    The project filter.
-- @param systemOnly
...
--
-- Return a list of makefile-specific filter rules. This will
...
-- provided filter and the operating environment. I will
-- be moving these into global filter blocks when I get
-- the chance.
--
-- @param cfg
--    The filter to query.
